/**
 * Updates every product in MongoDB Atlas with a real photograph URL.
 * Uses stable Unsplash photo permalink URLs (no API key, no redirects, always available).
 * Run: node src/seed/updateProductImages.js
 */
...
// Real Unsplash photo URLs — each is a direct CDN link to a specific photograph
// that matches the product visually.
const PRODUCT_IMAGES = {
  ...
  // ── Basketball ────────────────────────────────────────────────────────────
  'Official Basketball':
    'https://images.unsplash.com/photo-1546519638405-a9f82048e9f8?w=600&q=80',
  ...
  'Goalkeeper Gloves Pro':
    'https://images.unsplash.com/photo-1553778263-73a83bab9b0c?w=600&q=80',

  // ── Tennis ────────────────────────────────────────────────────────────────
  'Professional Tennis Racket':
    'https://images.unsplash.com/photo-1551773188-0801da12ddae?w=600&q=80',
  'Tennis Ball Can (3 balls)':
    'https://images.unsplash.com/photo-1521075486433-bf4052bb37bc?w=600&q=80',
  'Tennis Shoes Clay Court':
  ...
  'Cycling Shoes Clipless':
    'https://images.unsplash.com/photo-1517215002853-c2b51d50b8e6?w=600&q=80',
  ...
  'Taekwondo Sparring Gear':
    'https://images.unsplash.com/photo-1544717302-de2939b7ef71?w=600&q=80',
  ...
  'Professional Table Tennis Bat':
    'https://images.unsplash.com/photo-1611251135345-18c56206b863?w=600&q=80',
  ...
  'Feather Shuttlecocks':
    'https://images.unsplash.com/photo-1617083934555-ac7e4c1b3765?w=600&q=80',

  // ── Archery ───────────────────────────────────────────────────────────────
  'Recurve Bow 70"':
    'https://images.unsplash.com/photo-1553481187-be93c21490a9?w=600&q=80',
  'Carbon Arrows Set of 12':
    'https://images.unsplash.com/photo-1533514119692-b21bc5f4efb6?w=600&q=80',

  // ── Hockey ────────────────────────────────────────────────────────────────
  'Field Hockey Stick Composite':
    'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=600&q=80',
  'Hockey Ball Official':
  ...
  'Cricket Ball Leather White':
    'https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=600&q=80',
  'Batting Gloves Professional':
    'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=600&q=80',
  'Wicket Keeping Gloves':
    'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=600&q=80',
  'Cricket Pads Leg Guards':
    'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=600&q=80',
  'Cricket Helmet with Grill':
  ...
  'Cricket Abdominal Guard':
    'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=600&q=80',
  'Cricket Stumps Set':
    'https://images.unsplash.com/photo-1594470117722-de4b9a02ebed?w=600&q=80',
  'Cricket Kit Bag':
    'https://images.unsplash.com/photo-1553778263-73a83bab9b0c?w=600&q=80',
};
...
const run = async () => {
  ...
  console.log(`\n📦 Found ${products.length} products. Updating images...\n`);

  let updated = 0;
  let skipped = 0;

  for (const product of products) {
    const url = PRODUCT_IMAGES[product.name];
    if (!url) {
      console.log(`⚠️  No image mapped for: "${product.name}" — skipping`);
      skipped++;
      continue;
    }
    product.image  = url;
